...
class GUI():
    ...
    def __init__(self, layout, output, sysIn, logger, imageManager, CONFIG_DATA):
        ...
        self.attackParameters={
            'eps':FloatText(description='Epsilon', step=0.0001, value=0.0),
            'iterations':IntText(description='Iterations'),
            'stepsize':FloatText(description='Stepsize', step=0.0001, value=0.000),
